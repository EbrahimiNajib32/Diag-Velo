...
final class Version20240424201017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, role INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE velo (id INT AUTO_INCREMENT NOT NULL, proprietaire_id INT NOT NULL, numero_de_serie VARCHAR(255) DEFAULT NULL, marque VARCHAR(255) NOT NULL, ref_recyclerie INT DEFAULT NULL, couleur VARCHAR(255) DEFAULT NULL, poids INT DEFAULT NULL, taille_roues NUMERIC(10, 0) DEFAULT NULL, taille_cadre NUMERIC(10, 0) DEFAULT NULL, etat VARCHAR(255) NOT NULL, url_photo VARCHAR(255) DEFAULT NULL, date_de_reception DATETIME NOT NULL, date_de_vente DATETIME DEFAULT NULL, type VARCHAR(255) NOT NULL, emplacement VARCHAR(255) DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, date_destruction DATE DEFAULT NULL, public VARCHAR(255) DEFAULT NULL, INDEX IDX_354971F576C50E4A (proprietaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
