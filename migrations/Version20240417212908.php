 ...
 */
final class Version20240417212908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE diagnostic_element ADD CONSTRAINT FK_FA7C8889BE696DF2 FOREIGN KEY (id_etat) REFERENCES etat_control (id)');
    }
